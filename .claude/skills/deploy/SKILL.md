---
name: deploy
description: Configura CI/CD completo para novo projeto na Digital AI — Reusable Workflow, DNS Cloudflare automático, Docker Swarm. Use quando criar ou configurar deploy de qualquer projeto.
argument-hint: "[nome-do-projeto] [dominio.digital-ai.tech]"
allowed-tools: Read, Write, Edit, Grep, Glob, Bash, WebFetch
---

# Deploy — Estrutura CI/CD Digital AI

Guia completo para configurar o deploy automático de qualquer projeto na Digital AI.
...
## Arquivo 2: `docker-stack.yml` (template padrão)
...
| Projeto | Repo | Domínio | Tipo |
|---------|------|---------|------|
| pibi | DIGITAL-AI-TECH/pibi | pibi.digital-ai.tech | Build customizado (PayloadCMS + Next.js) |
